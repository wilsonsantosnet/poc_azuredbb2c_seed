...
export class AuthSettings {
  ...
  constructor() {
    this.TYPE_LOGIN = ETypeLogin.B2C;
    this.CLIENT_ID = 'b272662f-05ef-46dc-8ff4-f8e420bad0e9';
    this.CLIENT_ID_RO = 'b272662f-05ef-46dc-8ff4-f8e420bad0e9';
    this.CLIENT_ID_CC = "Seed-spa-anonymous";
    this.CLIENT_SECRET_CC = "4aa288ca-1603-45c2-85c3-b41a08d2bd0a";
    this.SCOPE = "openid profile email https://seedazb2c.onmicrosoft.com/eeee7c4c-0004-4077-b64e-03b1fa2991af/access_api";
    this.CACHE_TYPE = ECacheType.LOCAL;
